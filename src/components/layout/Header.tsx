          ...
          <div className="flex h-14 sm:h-16 items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <button
                ...
                className="relative cursor-pointer text-foreground hover:text-primary transition-colors p-2 bg-transparent border-none"
              ...
              {currentUser ? (
                <>
                  ...
                  {/* Cart */}
                  <div className="hidden sm:block">
                    <Link to="/cart" className="inline-flex items-center justify-center h-8 w-8 sm:h-9 sm:w-9 cursor-pointer select-none outline-none nav-icon" aria-label="Mon panier">
                  ...
                  <div className="hidden sm:block">
                    <Link to="/messages" className="inline-flex items-center justify-center h-8 w-8 sm:h-9 sm:w-9 cursor-pointer select-none outline-none nav-icon" aria-label="Mes messages">
                      <span className="relative inline-block align-middle leading-none">
